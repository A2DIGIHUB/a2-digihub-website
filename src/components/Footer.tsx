      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services#digital-transformation" className="hover:text-white">Digital Transformation</Link></li>
              ...
              <li><Link to="/services#ai-ml" className="hover:text-white">AI & Machine Learning</Link></li>
            </ul>
          </div>
