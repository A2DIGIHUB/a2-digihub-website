  ...
  const sections = [
    {
      ...
      content: `These terms and conditions outline the rules and regulations for the use of OKIKE's services and website.`,
    },
    {
      title: 'Acceptance of Terms',
      icon: ScaleIcon,
      content: `By accessing this website and using our services, you accept these terms and conditions in full. Do not continue to use OKIKE's website if you do not accept all of the terms and conditions stated on this page.`,
    },
    {
          ...
          <div className="mt-16 space-y-8">
            ...
            >
              ...
              <p className="text-ios-subtext mb-6 leading-relaxed">
                Unless otherwise stated, OKIKE and/or its licensors own the intellectual property rights for all material on this website. All intellectual property rights are reserved.
              </p>
              ...
              <p className="text-ios-subtext mb-6 leading-relaxed">
                In these terms and conditions, "Your Content" shall mean any audio, video text, images or other material you choose to display on this website. By displaying Your Content, you grant OKIKE a non-exclusive, worldwide irrevocable, sub licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.
              </p>

              <h3 className="text-xl font-bold text-ios-text mt-8 mb-4">4. No Warranties</h3>
              <p className="text-ios-subtext mb-6 leading-relaxed">
                This website is provided "as is," with all faults, and OKIKE express no representations or warranties, of any kind related to this website or the materials contained on this website.
              </p>

              <h3 className="text-xl font-bold text-ios-text mt-8 mb-4">5. Limitation of Liability</h3>
              <p className="text-ios-subtext mb-6 leading-relaxed">
                In no event shall OKIKE, nor any of its officers, directors and employees, be held liable for anything arising out of or in any way connected with your use of this website.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="text-ios-subtext space-y-2">
                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-ios-blue" /> Email: legal@okike.com</li>
